...
part 'get_org_event.dart';
part 'get_org_state.dart';

class GetOrgBloc extends Bloc<GetOrgData, GetOrgState> {
  GetOrgBloc() : super(GetOrgInitial()) {
    on<GetOrgData>((event, emit) async {
      List<dynamic> data = [];
...
Future<QuerySnapshot<Map<String, dynamic>>> fetchDataFromFirestore() {
  ...
  final collectionRef = firestore.collection('Org');
